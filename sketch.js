...
function draw() {
  ...
  if (gameState === "start") {
    ...
    textSize(20);
    fill("white");
    text("Welcome to Galaxy Defender! You objective in this game is to survive for as long as possible. To control your defender,  which has guns, use the up and down arrow keys. Use the space key to shoot the enemies approaching from the left side. Shoot them before they touch you command crafts. As your score increases, the speed of your enemies will, too. Good luck!", displayWidth / 4 + 40, displayHeight / 4, 600);
    text("Press 'space' to continue!", displayWidth / 3 + 50, displayHeight / 2);
